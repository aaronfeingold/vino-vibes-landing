    ...
    >
      <div className="mb-20">
        <div className="text-center mb-12">
          <h2
            className={`text-2xl md:text-3xl font-bold mb-4 bg-clip-text text-slate-100 transition-all duration-700 ${
              isIntersecting
          ...
          <p
            className={`text-lg text-slate-100 transition-all duration-700 delay-200 ${
              isIntersecting
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`backdrop-blur-sm bg-white/10 border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-700 hover:scale-105 hover:shadow-lg hover:shadow-slate-500/20 ${
                isIntersecting
            ...
            >
              ...
              <div className="text-sm text-slate-100 flex items-center justify-center gap-1">
