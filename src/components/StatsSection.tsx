    ...
    >
      <div className="mb-20">
        <div className="text-center mb-12">
          <h2
            className={`text-2xl md:text-3xl font-bold mb-4 bg-clip-text text-black transition-all duration-700 ${
              isIntersecting
          ...
          <p
            className={`text-lg text-black transition-all duration-700 delay-200 ${
              isIntersecting
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-sm text-black flex items-center justify-center gap-1">
