    ...
    >
      <div className="text-left relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:items-start">
          <h1
            id="tagline"
            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-9xl font-bold text-black mt-4 leading-tight text-center md:text-left md:flex-1"
          >
        ...
        <div className="flex flex-col font-bold text-black text-center items-start pb-2 md:pb-0">
          ...
          <p className="text-lg font-bold md:text-xl lg:text-xl 2xl:text-2xl mb-2 md:mb-8 leading-relaxed">
            <span className="gradient-1-text"> Vino Vibes AI</span>: the{" "}
            <span className="gradient-2-text">knowledge</span> and{" "}
